...
import {
  ButtonCheckoutApplePay,
  ButtonCheckoutPaypal,
  ButtonMetamask,
  ButtonOperaWallet,
  ButtonPayEthereum,
  ButtonPayVisa,
} from '~/components/ui/payment-buttons';
...
export default function Lab1({
  ...
  return (
    <>
      ...
      <div className='text-5xl'>Lab 1</div>
      ...
      <p>
        ...
        <button
          type='button'
          className='p-4 sm:p-5 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none'
        >
          Large
        </button>
      </p>
      ...
      <p>
        ...
        >
          ...
          >
            <path
              fillRule='evenodd'
              d='M8.842 18.083a8.8 8.8 0 0 1-8.65-8.948 8.841 8.841 0 0 1 8.8-8.652h.153a8.464 8.464 0 0 1 5.7 2.257l-2.193 2.038A5.27 5.27 0 0 0 9.09 3.4a5.882 5.882 0 0 0-.2 11.76h.124a5.091 5.091 0 0 0 5.248-4.057L14.3 11H9V8h8.34c.066.543.1 1.09.1 1.64-.008 5.23-3.736 9.442-8.598 9.442Z'
              clipRule='evenodd'
            />
          </svg>
          Sign in with Google
